...
VALUES (
        ...
        '$argon2i$v=19$m=16,t=2,p=1$RFhybWRKQmRpeUF2d2FGUw$HEhYdkwnZoeSDH6aSRsavw',
        'admin_user',
        '1990-01-01',
        NULL,
        '2024-09-15 09:00:00',
...
VALUES (
        ...
        'Spanish Basics',
        'Fundamental Spanish vocabulary and phrases.',
        'public',
        '2024-01-12 11:00:00',
        '2024-06-01 14:00:00',
        1
    ...
    (
        ...
        'World Capitals',
        'Flashcards for capitals of countries.',
        'public',
        '2024-02-05 09:30:00',
        '2024-02-05 09:30:00',
        1
    ...
    (
        ...
        'Physics Formulas',
        'Key formulas for introductory physics.',
        'private',
        '2024-02-20 16:00:00',
        '2024-07-15 10:00:00',
        1
    ...
    (
        ...
        'Italian Phrases',
        'Common phrases for traveling in Italy.',
        'public',
        '2024-04-15 10:00:00',
        '2024-04-15 10:00:00',
        1
    ...
    (
        ...
        'Diagrams and functions of cell parts.',
        'private',
        '2024-05-02 14:45:00',
        '2024-05-02 14:45:00',
        1
    ...
    (
        'b8c9d0e1-f2a3-4567-8901-cdef01234567',
        'Historical Dates',
    ...
    (
        'c9d0e1f2-a3b4-5678-9012-def012345678',
    ...
    (
        'd0e1f2a3-b4c5-6789-0123-ef0123456789',
...
VALUES (
    ...
    (
        'e1d2c3b4-a5f6-7890-1234-56789abcdef0',
        'Science Studies',
        'private',
        '2024-02-15 11:00:00',
        '2024-02-15 11:00:00',
    ...
    (
        'd2c3b4a5-f6e7-8901-2345-6789abcdef01',
        'History Buff',
        'public',
        '2024-03-01 14:30:00',
        '2024-08-20 12:00:00',
    ...
    (
        'c3b4a5f6-e7d8-9012-3456-789abcdef012',
        'Programming',
        'private',
        '2024-03-12 10:00:00',
        '2024-03-12 10:00:00',
    ...
    (
        'b4a5f6e7-d8c9-0123-4567-89abcdef0123',
        'Travel Prep',
        'public',
        '2024-04-10 16:00:00',
        '2024-04-10 16:00:00',
    ...
    (
        'a5f6e7d8-c9b0-1234-5678-9abcdef01234',
        'Personal Notes',
        'private',
        '2024-05-05 13:00:00',
        '2024-09-05 09:00:00',
    ...
    (
        'f6e7d8c9-b0a1-2345-6789-abcdef012345',
        'Work Projects',
        'private',
        '2024-06-01 17:00:00',
        '2024-06-01 17:00:00',
    ...
    (
        'e7d8c9b0-a1f2-3456-7890-bcdef0123456',
        'Exam Revision',
        'private',
        '2024-06-20 10:45:00',
        '2024-06-20 10:45:00',
    ...
    (
        'd8c9b0a1-f2e3-4567-8901-cdef01234567',
        'Spanish Resources',
        'public',
        '2024-07-15 12:10:00',
        '2024-07-15 12:10:00',
    ...
    (
        'c9b0a1f2-e3d4-5678-9012-def012345678',
        'Coding Snippets',
        'private',
        '2024-08-01 19:30:00',
        '2024-08-01 19:30:00',
...
VALUES (
    ...
    (
        'c7a8b9c0-d1e2-f3a4-b5c6-d7e8f9a0b1c2',
    ...
    (
        'd8b9c0d1-e2f3-a4b5-c6d7-e8f9a0b1c2d3',
    ...
    (
        'e9c0d1e2-f3a4-b5c6-d7e8-f9a0b1c2d3e4',
    ...
    (
        'f0d1e2f3-a4b5-c6d7-e8f9-a0b1c2d3e4f5',
        'Study Group - History Exam',
        5,
        '2024-08-05 19:00:00',
        '2024-08-05 19:00:00',
        1
...
VALUES (
        'fc1d2e3f-a4b5-c6d7-e8f9-a0b1c2d3e4f5',
        'Hello',
        'Hola',
        NULL,
        NULL,
        'Basic Spanish greeting',
        '2024-01-13 10:00:00',
        '2024-01-13 10:00:00',
        'a1b2c3d4-e5f6-7890-1234-567890abcdef'
    ),
    (
        'fc2d3e4f-b5c6-d7e8-f9a0-b1c2d3e4f5a6',
        'Thank you',
        'Gracias',
        NULL,
        'https://example.com/audio/gracias.mp3',
        NULL,
        '2024-01-13 10:05:00',
        '2024-01-13 10:05:00',
        'a1b2c3d4-e5f6-7890-1234-567890abcdef'
    ...
    (
        'fc3e4f5a-c6d7-e8f9-a0b1-c2d3e4f5a6b7',
        'Japan',
        'Tokyo',
        'https://example.com/img/tokyo.jpg',
        NULL,
        'Capital city',
        '2024-02-06 11:00:00',
        '2024-02-06 11:00:00',
    ...
    (
        'fc4f5a6b-d7e8-f9a0-b1c2-d3e4f5a6b7c8',
        'France',
        'Paris',
        NULL,
        NULL,
    ...
    (
        'fc5a6b7c-e8f9-a0b1-c2d3-e4f5a6b7c8d9',
        'Force',
        'F = ma',
        NULL,
        NULL,
    ...
    (
        'fc6b7c8d-f9a0-b1c2-d3e4-f5a6b7c8d9e0',
    ...
    (
        'fc7c8d9e-a0b1-c2d3-e4f5-a6b7c8d9e0f1',
        'Declare a variable (modern JS)',
        'let variableName;',
        NULL,
        NULL,
        'Use let or const',
    ...
    (
        'fc8d9e0f-b1c2-d3e4-f5a6-b7c8d9e0f1a2',
        'Where is the bathroom?',
        'Dovè il bagno?',
        NULL,
        'https://example.com/audio/bagno.mp3',
        NULL,
        '2024-04-16 12:00:00',
        '2024-04-16 12:00:00',
        'f6a7b8c9-d0e1-2345-6789-0abcdef01234'
    ...
    (
        'fc9e0f1a-c2d3-e4f5-a6b7-c8d9e0f1a2b3',
        'Powerhouse of the cell',
        'Mitochondria',
        'https://example.com/img/mito.png',
        NULL,
        NULL,
        '2024-05-03 10:30:00',
        '2024-05-03 10:30:00',
    ...
    (
        'fc0f1a2b-d3e4-f5a6-b7c8-d9e0f1a2b3c4',
        'Bread',
        'Le pain',
        NULL,
        NULL,
